%% This script generates the results in Table 5 in the manuscript
...
iter=0;
for freq=[15,30]
    disp(['Calculations started for frequency of ',num2str(freq),' minutes ...']);
...
fl_lbl=['Quantify_',num2str(oos_period_range_test(1)),...
        '_',num2str(oos_period_range_test(end)),'_multiM',...
