%% This script generates the results in Table 6 in the manuscript
...
iter=0;
for IS_per=[66,126]
    disp(['Calculations started for case of using past ',num2str(IS_per),' days ...']);
